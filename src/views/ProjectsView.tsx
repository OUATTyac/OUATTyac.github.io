...
import { FolderGit2, ExternalLink, Github, Sparkles, CheckCircle2, Layers, Cpu, Code2, Play } from 'lucide-react';
  ...
  return (
    <div className="space-y-10 pb-12 animate-fade-in">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-sm space-y-6">
        ...
        {/* Tab Navigation for Selected Project */}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {(Array.isArray(t(activeProject.keyFeatures)) ? t(activeProject.keyFeatures) : []).map((feat: string, idx: number) => (
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {(activeProject.technologies || []).map(tech => (
                  <span key={tech} className="px-3 py-1.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 font-semibold text-xs border border-indigo-200/60 dark:border-indigo-800/60">
                    {tech}
                  </span>
                ))}
              </div>
